...
name: 辽科大社团
navdetail: 辽宁科技大学社团
detial: 空气动力学及飞行器原理及制造研究社
---

# unplugin-vue-markdown

<button class="l_btn" @click="$router.push('./kfres/')">
sss
</button>
...
module.exports = {
  ...
  chainWebpack: (config) => {
    config.module.rule('vue').test(/\.(vue|md)$/) // <-- allows Vue to compile Markdown files

    config.plugin('markdown').use(
      Markdown({
